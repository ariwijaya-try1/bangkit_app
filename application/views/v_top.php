                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item <?php echo ($data['grup_menu_active'] == 'dashboard') ? 'menu-open' : ''; ?>">
                            ...
                            <li class="nav-item <?php echo ($data['grup_menu_active'] == 'data') ? 'menu-open' : ''; ?>">
                                <a href="#" class="nav-link">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('main'); ?>/rombel" class="nav-link <?php if ($data['menu_active'] == 'rombel') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Rombongan Belajar</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('main'); ?>/daftar_rombel" class="nav-link <?php if ($data['menu_active'] == 'daftar_rombel') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Nilai siswa</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('main'); ?>/siswa" class="nav-link <?php if ($data['menu_active'] == 'siswa') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>siswa</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('main'); ?>/wali" class="nav-link <?php if ($data['menu_active'] == 'wali') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Wali</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('main'); ?>/personel" class="nav-link <?php if ($data['menu_active'] == 'personel') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Personel</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item <?php echo ($data['grup_menu_active'] == 'masterdata') ? 'menu-open' : ''; ?>">
                                <a href="#" class="nav-link">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('masterdata'); ?>/kelas" class="nav-link <?php if ($data['menu_active'] == 'kelas') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Kelas</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('masterdata'); ?>/jabatan" class="nav-link <?php if ($data['menu_active'] == 'jabatan') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Jabatan</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('masterdata'); ?>/identitas" class="nav-link <?php if ($data['menu_active'] == 'identitas') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Identitas</p>
                                        </a>
                                    </li>
