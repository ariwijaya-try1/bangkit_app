                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="./masterumat" class="nav-link <?php if ($data['menu_active'] == 'masterumat') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Master Umat</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="./customer" class="nav-link <?php if ($data['menu_active'] == 'customer') echo "active"; ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Customer</p>
                                        </a>
                                    </li>
