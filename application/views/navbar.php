            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="./dashboard" class="nav-link <?php if ($this->uri->segment('2') == 'dashboard') echo "active"; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="./dataumat" class="nav-link <?php if ($this->uri->segment('2') == 'dataumat') echo "active"; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Umat</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="./index2" class="nav-link <?php if ($this->uri->segment('2') == 'index2') echo "active"; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>xxx</p>
                            </a>
                        </li>
